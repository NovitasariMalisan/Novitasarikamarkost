...
public final class main {
    ...
    public static void insert() throws IOException { 
        ...
        if(pil == 1){
            ...
            int lamasewa =  Integer.parseInt(input.readLine());
            System.out.println("=============================================");
            VIP vip = new VIP(nama, alamat, noHp, status, lamasewa);
            listVip.add(vip);
            vip.info(nama);
            ...
            int lamasewa =  Integer.parseInt(input.readLine());
            System.out.println("=============================================");
            Reguler Regu =new Reguler(nama, alamat, noHp, status,lamasewa);
            listRegu.add(Regu);
            Regu.info(nama);
        ...
        if(pil == 1){
            if (listVip.isEmpty()) {
                ...
                if (index <= listVip.size() || index > 0){
                     ...
                     System.out.print("Masukkan Lama Sewa    :" );
                     int lamasewa = Integer.parseInt(input.readLine());
                     listVip.get(index-1).setLamasewa(lamasewa);
